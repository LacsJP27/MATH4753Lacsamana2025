#' My max likelihood norm function
#'
#' @param x sample
#' @param mu mus to test
#' @param sig sigmas to test
#' @param ...
#'
#' @returns a graphical depiction of the estimate of the maximum likelihood value
#' @export
#'
#' @examples
